...
Decay_WR__plus__ = Decay(name = 'Decay_WR__plus__',
                         ...
                         partial_widths = {(P.c,P.b__tilde__):'(ee**2*MWR**4*Ycb**2)/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.c,P.d__tilde__):'(ee**2*MWR**4*Ycd**2)/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.c,P.s__tilde__):'(ee**2*MWR**4*Ycs**2)/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.t,P.b__tilde__):'(ee**2*MWR**4*Ytb**2)/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.t,P.d__tilde__):'(ee**2*MWR**4*Ytd**2)/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.t,P.s__tilde__):'(ee**2*MWR**4*Yts**2)/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.u,P.b__tilde__):'(ee**2*MWR**4*Yub**2)/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.u,P.d__tilde__):'(ee**2*MWR**4*Yud**2)/(16.*cmath.pi*sw**2*abs(MWR)**3)',
                                           (P.u,P.s__tilde__):'(ee**2*MWR**4*Yus**2)/(16.*cmath.pi*sw**2*abs(MWR)**3)'})
